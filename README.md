...
1. 先在 **電子書** 分頁 →【**獲得**】書櫃**雙擊一本書**開始閱讀（程式自動切到【**內容**】子頁籤）；**左側章節目錄**列出該書各章，點選某章即從那章讀起。
...
![電子書內容頁（閱讀器·實機）：左＝章節目錄｜中＝閱讀區（當前段放大高亮、逐字可點查詞、對白依說話人上色）＋控制列（上一段／下一段／繼續／朗讀／語速／主題）｜右＝逐段清單＋說話人面板](docs/manual-assets/ebook-reader.png)
